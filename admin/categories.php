...
?>
<h2 class="text-center" style="margin-top: 130px;">Categories</h2>
<hr>
...
<div class="row">
	...
	<!-- Form -->
	<div class="col-md-6">
		<form class="form" style="margin-left: 10px;" action="categories.php<?php echo ((isset($_GET['edit']))?'?edit='.$edit_id : ''); ?>" method="post">
		...
		<table class="table" style="margin-right: 30px;">
			...
			<tbody>
				...
				<tr>
					...
					<td>Parent</td>
					<td>
						<a class="btn btn-xs btn-default" href="categories.php?edit=<?php echo $parent['id']; ?>"><i class="material-icons" >
edit
</i></a>
						<a class="btn btn-xs btn-default" href="categories.php?delete=<?php echo $parent['id']; ?>"><i class="material-icons">
delete
</i></a>
					</td>
				</tr>
					<?php while($child = mysqli_fetch_assoc($cresult)) : ?>
						<tr>
							...
							<td><?php echo $parent['category']; ?></td>
							<td>
								<a class="btn btn-xs btn-default" href="categories.php?edit=<?php echo $child['id']; ?>"><i class="material-icons" >
edit
</i></a>
								<a class="btn btn-xs btn-default" href="categories.php?delete=<?php echo $child['id']; ?>"><i class="material-icons">
delete
</i></a>
							</td>
						</tr>
