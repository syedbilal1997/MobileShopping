...
<body>
 ...
 <?php 
      $sql="SELECT * FROM products WHERE featured=12";
      $featured=$db->query($sql) ;
?>
<section class="arrivals">
 <div class="new-arrivals">
  <h1 align="center" style="margin-top: 130px;">Iphones</h1>
...
<script>    
    if(typeof window.history.pushState == 'function') {
        window.history.pushState({}, "Hide", "http://localhost:8080/Mobile%20Shopping/Iphones.php");
    }
</script>
