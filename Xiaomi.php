...
<body>
 ...
 <?php 
      $sql="SELECT * FROM products WHERE featured=14";
      $featured=$db->query($sql) ;
?>
<section class="arrivals">
 <div class="new-arrivals">
  <h1 align="center" style="margin-top: 130px;">Xiaomi</h1>
...
<script>    
    if(typeof window.history.pushState == 'function') {
        window.history.pushState({}, "Hide", "http://localhost:8080/Mobile%20Shopping/Xiaomi.php");
    }
</script>
