...
<html>
<head>
	<title>Ear phones Section</title>
 <meta charset="utf-8">
...
<body>
 ...
 <?php 
      $sql="SELECT * FROM products WHERE featured=8";
      $featured=$db->query($sql) ;
?>
<section class="arrivals">
 <div class="new-arrivals">
  <h1 align="center" style="margin-top: 130px;">Xiaomi Earphones</h1>
...
?>
 ...
 <?php 
      $sql="SELECT * FROM products WHERE featured=7";
      $featured=$db->query($sql) ;
?>
<section class="arrivals">
 <div class="new-arrivals">
  <h1 align="center" style="margin-top: 0;">Beats Earphones</h1>
 ...
 <?php 
      $sql="SELECT * FROM products WHERE featured=10";
      $featured=$db->query($sql) ;
?>
<section class="arrivals">
 <div class="new-arrivals">
  <h1 align="center" style="margin-top: 0;">Audionic Earphones</h1>
...
<script>    
    if(typeof window.history.pushState == 'function') {
        window.history.pushState({}, "Hide", "http://localhost:8080/Mobile%20Shopping/Ear%20Phones.php");
    }
</script>
